...
<head>
  ...
  <link rel="stylesheet" href="css/lovepaper.css">
</head>
...
<section class="top-header">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 col-sm-4 header-padding-top">


			
				

				<ul class="top-menu text-left list-inline link-inicio">
		  ...
		  <div class="col-md-4 col-xs-12 col-sm-4">
				<div class="logo text-center">
						<a href="https://lovepaper.com.ar" title>
							<img src="//dcdn.mitiendanube.com/stores/001/331/016/themes/common/logo-936715512-1702852481-9ea32bcafdadd48cd70f7676eab933741702852482-480-0.webp" alt="LOVE PAPER" class="logo-img" />
						</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-12 col-sm-4 header-padding-top">
				...
				<ul class="top-menu text-right list-inline">
					...
					<li class="dropdown search dropdown-slide">
						...
						<ul class="dropdown-menu search-dropdown">
							<li>
								<form action="post"><input type="search" class="form-control" placeholder="Busca tu producto..."></form>
							</li>
						</ul>
					</li><!-- / Search -->
					...
					<li class="dropdown cart-nav dropdown-slide">
						<a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><i
								class="tf-ion-android-cart"></i>(0)</a>
