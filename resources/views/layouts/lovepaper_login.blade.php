...
<a class="breadcrumb-crumb" href="#" title="Mi Cuenta">Mi Cuenta</a>
<span class="breadcrumb-divider">/</span>
<h1 class="breadcrumb-crumb active">Iniciar sesion</h1>
...
<input class="btn btn-primary full-width" type="submit" value="Iniciar sesión" />
<p class="m-top text-center"> ¿No tenés una cuenta? <a href="/register/" title class="weight-strong">Crear cuenta</a>
</form>
...
<span class="js-ajax-cart-total js-cart-subtotal pull-right cart-subtotal-price text-right weight-strong" data-priceraw="0" data-component="cart.subtotal" data-component-value="0">$0,00</span>
</div>
