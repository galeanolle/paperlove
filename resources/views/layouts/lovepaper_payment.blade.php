...
<center>
<p class="text-center-xs" style="font-size: 18px;margin-top:50px;"> 
...
<form id="login-form" action method="post" class="span6 offset3 contact_form" data-store="account-register" style="display: none;">
