...
<head>
    ...
    <script type="text/javascript">
        ...
        //LS.metricsWorkerScriptUrl = "https://dcdn.mitiendanube.com/assets/stores/js/metrics-worker-c984926f96a2e4787f155a9755d6944a30.js?v=85966542"
...
<span class="breadcrumb-divider">/</span>
<h1 class="breadcrumb-crumb active">Crear Cuenta</h1>
...
<p class="text-center-xs m-top m-bottom p-bottom"> Comprá más rápido y llevá el control de tus pedidos, ¡en un solo lugar! </p>
...
<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="ej.: María Perez">
...
-->
 ...
 <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="ej.: tunombre@email.com">
...
<!--
<input type="password" name="password" id="password" autocomplete="off" class="js-password-input form-control " />
-->
...
<!--
<input type="password" name="password_confirmation" id="password_confirmation" autocomplete="off" class="
js-password-input form-control " />
-->
...
<input class="btn btn-primary full-width" type="submit" value="Crear cuenta" />
<p class="m-top text-center"> ¿Ya tenés una cuenta? <a href="/login/" title class="weight-strong">Iniciá sesión</a>
</form>
...
</div><footer class="js-hide-footer-while-scrolling js-footer" data-store="footer">
<div class="footer">
