...
<a class="h6 font-body-xs crumb" href="https://lovepaper.com.ar" title="LOVE PAPER">Inicio</a>
<span class="breadcrumb-divider">/</span>
<a class="breadcrumb-crumb" href="/account" title="Mi Cuenta">Mi Cuenta</a>
<span class="breadcrumb-divider">/</span>
<h1 class="breadcrumb-crumb active">Proceso de pago</h1>
...
<div class="account-form-wrapper visible-when-content-ready m-bottom m-top row-fluid">
    ...
    <form id="form-checkout" name="form-checkout" method="POST" action="{{ route('checkout') }}">
        @csrf


<p class="text-center-xs m-top m-bottom p-bottom"> Ingresa tus datos y seleccioná la forma de pago que prefieras! </p>


<div class="form-group ">
<label for="name" class="form-label" style="font-size:18px">Tus datos</label>
...
<!--
<input autocorrect="off" autocapitalize="off" type="email" name="email" id="email" value class="form-control " placeholder="ej.: tunombre@email.com" />
-->
...
<input id="phonenumber" type="text" class="form-control @error('phonenumber') is-invalid @enderror" name="phonenumber" value="{{ old('phonenumber') }}" required autocomplete="phonenumber" placeholder="ej.: 11-2222-1222">
...
<input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" required autocomplete="city" placeholder="ej.: Buenos Aires">
...
<input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" placeholder="ej.: Av. Cabildo 1234 Piso 2 Depto C">
...
<input type="text" name="phone" id="phone" value class="form-control" placeholder="ej.: 1123445567" />
</div>
-->
...
<!--
<div class="g-recaptcha" data-sitekey="6LdvubwUAAAAAKg5583RDx5WbiQg-J3lUa_INUHR" data-callback="recaptchaCallback"></div>
-->

<!--
<input class="js-recaptcha-button btn btn-primary full-width" type="submit" value="Crear cuenta" disabled />-->
<hr>
...
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>{{$quantity}} Productos
</h6>

<a href="#" style="color:blue;" class="js-toggle-cart">Ver carrito
</a>
</div>
...
<li class="list-item" data-store="branch-item-branch_144277">
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>Costo de envío
</h6>
...
<div class="form-group ">
<label for="name" class="form-label" style="font-size:18px">Recepción del producto</label>
...
<li class="list-item" data-store="branch-item-branch_144277">
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>Retiro en nuestro local
</h6>
...
<li class="list-item" data-store="branch-item-branch_144277">
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>Envio a domicilio
</h6>
...
<hr>
<div class="form-group ">
<label for="name" class="form-label" style="font-size:18px">Forma de pago</label>
...
<li class="list-item" data-store="branch-item-branch_144277">
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>En efectivo en nuestro local
</h6>
...
<li class="list-item" data-store="branch-item-branch_144277">
<div class="row-fluid ">
<div class="span9 col-xs-9-custom pull-left pull-left-xs"><h6>A tráves de Mercado Pago
</h6>
...
<br>
<br>
<center><a href="/productos" style="font-size:16px;text-decoration:underline;">VER MAS PRODUCTOS
</a></center>
</form>
...
<form action="/comprar/" method="post" id="ajax-cart-details" class="js-ajax-cart-panel js-fullscreen-modal ajax-cart-container modal-right modal-xs modal-xs-right modal-xs-right-out" style="display: none;border:1px solid black;" data-store="cart-form" data-component="cart">
...
<span class="cart-subtotal-price pull-right text-right weight-strong" data-priceraw="0" data-component="cart.subtotal" data-component-value="0">$0,00</span>
</div>
...
<a href="/productos" class=" btn-link m-bottom" style="font-size:18px;">Ver más productos</a>
</div>
...
<script type="text/javascript">
    /*
        var recaptchaCallback = function() {
            jQueryNuvem('.js-recaptcha-button').prop('disabled', true);
        };
        */
...
function addCartItem(param){
    ...
    html += '<button type="button" class="cart-quantity-btn ajax-cart-quantity-btn cart-min-quantity" onclick="minQuantity('+param.id+');" style="display:none;">';
    ...
    html += '</div>';
    html += '</button>';
    html += '<div class="cart-quantity-input-container d-inline-block pull-left" style="font-size:18px;">';
    html += 'Total:   '+itemQuantity;
    html += '</div>';
    html += '<button type="button" class="cart-quantity-btn ajax-cart-quantity-btn cart-plus-quantity" onclick="plusQuantity('+param.id+')" data-component="quantity.plus" style="display:none;">';
    ...
    */
    ...
    html += '<button type="button" class="cart-btn-delete ajax-cart-btn-delete pull-right p-top-none" onclick="removeCartItem('+param.id+')" data-component="line-item.remove" style="display:none;">';
