                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                -->
                                <a href="{{ route('admin.variant') }}" class="dropdown-item">
                                    Modelos
                                </a>
                                <a href="{{ route('admin.category') }}" class="dropdown-item">
                                    Categorías
                                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a href="{{ route('profile.edit',['user'=>Auth::user()->id ]) }}" class="dropdown-item">Editar perfil</a>
...
$('#savestock').click(function(){
    ...
    for(var i = 0; i<q.length; i++){
        arr.push([$(q[i]).attr('data-id'),$(q[i]).val()]);
    }
    console.log(arr);
    $('#stock_info').val(JSON.stringify(arr));
    $('#form_save').submit();
