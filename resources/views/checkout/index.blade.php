@extends('layouts.lovepaper_checkout')
                ...
                <div class="row ">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <div>
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name ??'' }}" required autocomplete="name" autofocus disable>
                                @error('name')
