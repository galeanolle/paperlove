    ...
    <form method="POST" action="{{ route('product.create') }}" enctype="multipart/form-data">
        ...
        <div class="row ">
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    <div>
                        <input id="percent" type="number" placeholder="0" class="form-control @error('percent') is-invalid @enderror" name="percent" value="{{ old('percent')  }}" required autocomplete="percent" min="0" value="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
                        @error('percent')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
