...
<div class="col-12 col-md-12 col-sm-12 col-lg-12">
    ...
    <h5>Asignar un modelo al producto y agregar stock</h5>

    <hr>

    <form method="POST" action="{{ route('admin.addstock',['id'=>$product->id])}}" enctype="multipart/form-data">
        @csrf
        <div class="row ">
            ...
            <div class="col-12">
                <label for="size" class="">Nombre del modelo</label>
        ...
        <button type="submit" class="btn btn-success w-100">Asignar modelo y agregar stock</button>
